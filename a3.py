...
class mSDA(object):
    ...
    def _build(self):
        ...
        # net['gcn2'] = GCNLayer()
        # net['whiten1'] = ZCAWhitenLayer()
        # net['layer2'] = mDAELMLayer(C=self.C, n_hidden=1000, noise_type='mn', noise=0.25)
        return net
    ...
    def train(self, inputX, inputy):
        ...
        self.classifier = Classifier_SVMlincv_jobs(C_range=10 ** np.arange(-2., 2., 0.5))
        # self.classifier = Classifier_KELMcv(C_range=10 ** np.arange(0., 5., 0.5), kernel_type='rbf',
        #                                     kernel_args_list=10 ** np.arange(0, 5., 0.5))
