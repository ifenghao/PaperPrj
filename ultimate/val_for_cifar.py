...
class LRFELMAE(object):
    ...
    def _build(self):
        ...
        # net['gcn0'] = GCNLayer()
        # layer1
        # array_args1 = {'percent': 0.3, 'block_list': ((21, 21),),
        ...
        # net['layer1'] = ELMAECrossAllLayer(C=self.C, name=dir_name, n_hidden=32, fsize=6, act_mode='elu',
        #                                    pad=0, stride=1, pad_=0, stride_=1,
        #                                    noise_type='mn_array_mch', noise_args=ae_args1,
        #                                    add_pool=True, pool_type='fp', pool_size=1.7, mode='max',
        #                                    pool_args={'overlap': True,},
        #                                    add_cccp=False, cccp_out=32, cccp_noise_type='mn_array',
        #                                    cccp_noise_args=cccp_args1)
        # orient_args1 = {'pad': 0, 'stride': 1, 'percent': 0.3, 'block_list': ((21, 21),),
        #                 'p_add': 0.5, 'p_center_of_image': (0.8, 0.5)}
        ...
        #                                    cccp_noise_args=cccp_args1)
        edge_args1 = {'pad': 0, 'stride': 1, 'percent': 0.3, 'block_list': ((12, 12),),
        ...
        # net['gcn12'] = GCNLayer()
        # layer2
        # array_args2 = {'percent': 0.3, 'block_list': ((8, 8),),
        #                'mode': 'channel', 'p_add': 0.5,
        ...
        # net['layer2'] = ELMAELayer(C=self.C, name=dir_name, n_hidden=32, fsize=6, act_mode='elu',
        #                            pad=0, stride=1, pad_=0, stride_=1,
        ...
        # orient_args2 = {'pad': 0, 'stride': 1, 'percent': 0.3, 'block_list': ((8, 8),),
        #                 'p_add': 0.5, 'p_center_of_image': (0.8, 0.5)}
